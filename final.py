...
while True:
    ...
    print("2.- No elegidos")
    print("3.- Ver apariciones")
    print("4.- Ver media")
    print("5.- Mas frecuencia")
    print("6.- Menos frecuente")
    print("7.- Pares e impares")
    print("8.- Total")
    print("9.- Salir.")
    ...
    if opcion == "1":
        ...
        print("Número(s) más frecuente(s): ", end="")
        for i in range(10):
        ...
        print("Número(s) menos frecuente(s): ", end="")
        for i in range(10):
        ...
        print(f"Total apariciones de números pares: {pares}")
        print(f"Total apariciones de números impares: {impares}")
